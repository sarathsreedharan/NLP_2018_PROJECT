...
#
# Created: Thu Apr 12 23:04:50 2018
#      by: PyQt4 UI code generator 4.10.4
#
# WARNING! All changes made in this file will be lost!

from PyQt4 import QtCore, QtGui
from PyQt4.QtCore import QObject, SIGNAL, pyqtBoundSignal
import Backend
...
class Ui_Frame(object):
    def setupUi(self, Frame, backend):
    ...
    def initBoard(self):
        ...
        self.location2_text.setText("Brickyard")
        self.location3_text.setText("College Avenue")
    



    def setlocation(self,player,location):
        if(player == 1):
            self.location1_text.setText(location)
