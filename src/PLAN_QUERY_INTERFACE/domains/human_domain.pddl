(define (domain endemic)
   ...
   (:action fly_by_charter
    ...
    (:action build_research_station_new
        ...
        :precondition (and (< (research_station_count) 6) ) 
...
;        :parameters (?p - player ?c - city ?d - disease)
;        :precondition (and (> (city_disease_count ?c ?d) 0)  ) 
;        :effect (and (cured_disease_began ?c ?d) (decrease (total_per_city_count ?c) (city_disease_count ?c ?d)) (decrease (total_disease_count) (city_disease_count ?c ?d)))
;    )
